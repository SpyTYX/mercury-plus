...
local Library = {
	Themes = {
		...
		VSCodeMonokai = {
			Main = Color3.fromRGB(39, 40, 34),
			Secondary = Color3.fromRGB(30, 31, 28),
			Tertiary = Color3.fromRGB(52, 54, 47),

			StrongText = Color3.fromHSV(0, 0, 1),        
			WeakText = Color3.fromHSV(0, 0, 172/255)
		},
		PurplePassion = {
			Main = Color3.fromRGB(30, 0, 30),
			Secondary = Color3.fromRGB(47, 7, 50),
			Tertiary = Color3.fromRGB(63, 44, 67),
...
function Library:change_theme(toTheme)
	...
	Library.DisplayName.Text = "Welcome to MercuryPlus, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>"
...
function Library:create(options)
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = "Welcome to MercuryPlus, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>",
			TextScaled = true,
